...
class ImageReader(object):
  ...
  def __init__(self):
    ...
    self._decode_jpeg = tf.image.convert_image_dtype(self._decode_jpeg, dtype=tf.float32)
    #set_trace()
      ...
      for shard_id in range(_NUM_SHARDS):
        ...
        with tf.python_io.TFRecordWriter(output_filename) as tfrecord_writer:
          ...
          for i in range(start_ndx, end_ndx):
            ...
            #jpgcheck = 'jpeginfo' +' -c ' + filenames[i] + ' -d' +'\n'
   #         print(jpgcheck)
   #         sys.stdout.write('\n')
   #         sys.stdout.flush()
            #os.system(jpgcheck)
            ...
            try:
                ...
                print("filenames:%s,i:%d"%(filenames[i],i))
            ...
            #else:
             # print(filenames[i]+" is deleted\n")

      print("NoPassNum:%d"%(NoPassNum))
      sys.stdout.write('\n')
      sys.stdout.flush()
